...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6))).*...
    ((1+(x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^b(5)).^-1);
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6))).*...
    ((1+(x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^(b(3)+b(4))).^-1);
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6))).*...
    exp(-(x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^b(5));
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6))).*...
    exp(-(x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^(b(3)+b(4)));
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6))).*...
    (1-tanh((x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^b(5)));
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6))).*...
    (1-tanh((x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^(b(3)+b(4))));


beta0=[0.05,1,1,1]';

[mdl_3c2,beta_3c2]=getFit(X,y,fx,beta0);

checkFit(X,y,fx,beta_3c2,'3c2',12);
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6)).*...
    (1+(x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^b(5)));
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6)).*...
    (1+(x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^(b(3)+b(4))));
...
fx=@(b,x) ...
    ...
    tanh(4.5e-5.*x(:,8)).*...
    (1+0.33.*x(:,7).^2.*sqrt(x(:,4)).*x(:,5).*x(:,6)).*...
    (x(:,5)./x(:,10)).^b(3).*(x(:,5)./x(:,6)).^b(4).*(1-x(:,9)).^(b(3)+b(4)));
...
[mdl_x,beta_x]=getFit(X,y,fx,beta0);

checkFit(X,y,fx,beta_x,'x',19);
...
[mdl_y,beta_y]=getFit(X,y,fx,beta0);

checkFit(X,y,fx,beta_y,'y',20);
